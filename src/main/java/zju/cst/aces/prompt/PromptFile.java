...
public enum PromptFile {
    ...
    sofia_repair("PROMPT_TEMPLATE_SOFIA_REPAIR", "PROMPT_TEMPLATE_SOFIA_INIT_SYSTEM"),
    ...
    sofia_hits_test_repair("PROMPT_TEMPLATE_SOFIA_HITS_REPAIR", "PROMPT_TEMPLATE_SOFIA_HITS_SYS_REPAIR");
    // 成员变量
