...
public class EmbeddingClient {
    ...
    public JSONObject saveCode(String className, String methodName, String code, String signature, String comment, List<String> annotations) {
        ...
        inputJson.put("annotations", new JSONArray(annotations));
    ...
    public List<Map<String, String>> search_similar_methods(String code, int limit) {
    ...
    public static void main(String[] args) {
        ...
        client.search_similar_methods(code1, 2);
    }
}
